...
public class DataServiceImpl implements DataService {
    ...
    public void loadDataFromDataBase() {
        if (checkFilesEmpty()) {
            ...
            bookRepository.replaceAllBooks(books);

            List<Order> orders = orderRepository.findAll();
            orderRepository.replaceAllOrders(orders);

            List<Customer> customers = customerRepository.findAll();
            customerRepository.replaceAllCustomers(customers);
    ...
    private boolean checkFilesEmpty() {
        return isFileEmpty(bookJsonPath) || isFileEmpty(orderJsonPath) || isFileEmpty(customerJsonPath);
    }
