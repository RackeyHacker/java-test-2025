...
public class Main {
    public static void main(String[] args) {
        ...
        Book b1 = new Book("Clean Code", BookStatus.AVAILABLE, new BigDecimal("45.0"), cal.getTime(), "Best practices for writing clean code");
        cal.set(2020, Calendar.AUGUST, 21);
        Book b2 = new Book("Effective Java", BookStatus.UNAVAILABLE, new BigDecimal("55.0"), cal.getTime(), "Comprehensive guide to Java programming");
        cal.set(2015, Calendar.DECEMBER, 10);
        Book b3 = new Book("Design Patterns", BookStatus.AVAILABLE, new BigDecimal("60.0"), cal.getTime(), "Classic software design solutions");
