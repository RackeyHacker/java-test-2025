...
public class BookStore {
    ...
    private final String bookData = "data/csv/books.csv";
    private final String orderData = "data/csv/orders.csv";
    private final String customerData = "data/csv/customers.csv";
